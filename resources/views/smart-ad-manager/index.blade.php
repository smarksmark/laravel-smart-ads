                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    <div>
                                        <a href="{{route('smart-ads-show',$ad->id)}}">
                            ...
                            <td class="flex px-4 py-3 text-sm">
                                @if($ad->enabled)
                                    <form method="POST" action="{{route('smart-ads-disable',$ad->id)}}"
                                ...
                                @else
                                    <form method="POST" action="{{route('smart-ads-enable',$ad->id)}}"
                                          onsubmit="return confirm('Are you sure you want to enable the ad?');">
                                        @csrf
                                        <button type="submit">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                 stroke-width="1.5" stroke="currentColor"
                                ...
                                @endif
                                <a href="{{route('smart-ads-edit',$ad->id)}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke-width="1.5" stroke="currentColor"
                                         class="w-5 h-5 cursor-pointer mr-3 text-yellow-600">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                              d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10"/>
                                    </svg>
                                </a>
                                <form method="POST" action="{{route('smart-ads-delete',$ad->id)}}"
